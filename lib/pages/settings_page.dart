  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading:
                  Icon(Icons.language, color: AppColors.primaryColor, size: 30),
              title: Text(
                'Langue',
                style: TextStyle(
                  fontSize: 18,
            ...
            ListTile(
              leading:
                  Icon(Icons.security, color: AppColors.primaryColor, size: 30),
              title: Text(
            ...
            ListTile(
              leading:
                  Icon(Icons.feedback, color: AppColors.primaryColor, size: 30),
              title: Text(
                'Commentaires',
                style: TextStyle(
                  fontSize: 18,
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        index:
            2, // Index de l'icône des paramètres pour qu'il soit activé par défaut
      ),
    );
  }
