...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false, // Pour supprimer le bouton de retour automatique
        title: Row(
          ...
          children: [
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 4.0), // Ajustez les valeurs de padding selon vos besoins
                  child: Text(
                    'Bonjour, Mohamed',
                    style: TextStyle(
                      fontSize: 18,
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.grey.withOpacity(0.25), // Couleur de l'ombre
            ...
            BoxShadow(
              ...
              offset: Offset(0, 1), // Décalage horizontal et vertical de l'ombre
...
Widget _buildFloatingActionButton() {
  return Container(
    ...
    child: Column(
      ...
      children: [
        Expanded(child: SizedBox()), // Cet Expanded prendra tout l'espace disponible au-dessus du bouton
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            TextButton(
